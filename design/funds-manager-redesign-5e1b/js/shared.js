...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'planning', href: 'funds-planning.html', label: 'Planning', icon: 'plan', badge: 2 },
    ],
  },
  {
    id: 'net-worth',
...
const COMMAND_ACTIONS = [
  ...
  },
  {
    ...
    icon: 'snap',
    href: 'funds-report-snapshots.html?create=1',
  },
  {
    id: 'add-plan-cashflow',
    label: 'Add cashflow plan',
    detail: 'Dated spend or income',
    icon: 'plan',
    href: 'funds-planning.html?add=cashflow',
  },
  {
    id: 'add-plan-redraw',
    label: 'Add loan redraw',
    detail: 'Credit account · raise loan balance',
    icon: 'plan',
    href: 'funds-planning.html?add=loan_redraw',
  },
  {
    id: 'add-plan-refinance',
    label: 'Add refinance plan',
    detail: 'Settle old liability · new terms',
    icon: 'plan',
    href: 'funds-planning.html?add=loan_refinance',
  },
  {
    id: 'add-plan-repayment',
    label: 'Add repayment change',
    detail: 'New repayment or rate from a date',
    icon: 'plan',
    href: 'funds-planning.html?add=loan_repayment_change',
  },
];
