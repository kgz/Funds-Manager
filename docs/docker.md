...
Upload bank statement PDFs via **Statements** in the UI.
...
|----------|-------------------|-------------|
| `DATABASE_URL` | `postgres://funds:funds@postgres:5432/funds` | Set automatically in compose |
...
Postgres data is stored in the `postgres_data` Docker volume. To reset:
