...
Detect and manage inter-account transfer pairs so internal movements are not double-counted as spending and income.
...
Confirmed transfer transactions MUST be excluded from spending and income sums on dashboard KPIs, monthly charts, category breakdown, drilldowns, recurring detection, income streams, predictions, lender expense spend totals, and category usage stats.
